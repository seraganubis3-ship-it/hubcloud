...
export const StickyAddToCart: React.FC<StickyAddToCartProps> = ({
  ...
  return (
    <div className="fixed bottom-[57px] md:bottom-0 left-0 right-0 z-30 bg-white/95 backdrop-blur-md border-t border-gray-200 shadow-[0_-4px_20px_rgba(0,0,0,0.08)] p-2.5 sm:p-3 animate-in slide-in-from-bottom-3 duration-200">
