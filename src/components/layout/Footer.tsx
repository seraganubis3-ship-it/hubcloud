                ...
                if (social.id === 'tiktok') {
                  return (
                    <a
                      ...
                      className="w-7 h-7 sm:w-8 sm:h-8 rounded-full bg-black hover:opacity-90 flex items-center justify-center text-white transition-transform hover:scale-105 shadow-sm border border-white/10"
                    >
